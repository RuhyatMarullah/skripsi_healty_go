<div class="container-fluid">
    <div class="row">
        <div class="col">
            <h3><strong>Form Ubah Obat</strong></h3>
        </div>
    </div>
</div>
<div class="container-fluid">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="hidden" value="<?= $obat['kd_obat']; ?>" name="kode_obat">
                    <input type="text" id="nama_obat" class="form-control <?php if (form_error('nama_obat')) { ?>
                        is-invalid
                    <?php  } ?>" name="nama_obat" value="<?= $obat['nama_obat']; ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="harga_obat" class="form-control <?php if (form_error('harga_obat')) { ?>
                        is-invalid
                    <?php  } ?>" name="harga_obat" value="<?= $obat['harga_obat']; ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="keterangan_obat" class="form-control <?php if (form_error('keterangan_obat')) { ?>
                        is-invalid
                    <?php  } ?>" name="keterangan_obat" value="<?= $obat['keterangan']; ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="jml_obat" class="form-control <?php if (form_error('jml_obat')) { ?>
                        is-invalid
                    <?php  } ?>" name="jml_obat" value="<?= $obat['jml_obat']; ?>">
