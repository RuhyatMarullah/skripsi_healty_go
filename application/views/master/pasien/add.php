<div class="container-fluid">
    <div class="row">
        <div class="col">
            <h3><strong>Form Tambah Pasien</strong></h3>
        </div>
    </div>
</div>
<div class="container-fluid">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="no_identitas" class="form-control <?php if (form_error('no_identitas')) { ?>
                        is-invalid
                    <?php  } ?>" name="no_identitas" value="<?= set_value('no_identitas'); ?>" placeholder="No KTP / No KK">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" id="tgl_lahir" class="form-control <?php if (form_error('tgl_lahir')) { ?>
                        is-invalid
                        <?php  } ?>" name="tgl_lahir" value="<?= set_value('tgl_lahir'); ?>">
