            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control <?php if (form_error('keluhan')) { ?>
                        is-invalid
                        <?php  } ?>" id="keluhan" rows="3" name="keluhan"><?= set_value('keluhan'); ?></textarea>
                    <?= form_error('keluhan', '<small class="text-danger pl-1">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="lab" id="lab" value="2">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control <?php if (form_error('diagnosa')) { ?>
                        is-invalid
                        <?php  } ?>" id="diagnosa" rows="3" name="diagnosa"><?= set_value('diagnosa'); ?></textarea>
                    <?= form_error('diagnosa', '<small class="text-danger pl-1">', '</small>'); ?>
                </div>
            </div>
            <div class="col-md-4">
                <button type="submit" class="btn btn-primary" name="tambah">Next</button>
                <a href="<?= base_url('poli/gigi'); ?>" type="button" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </form>
</div>
