...
<body id="page-top">
    <h2 class="text-center mb-5">Hasil Pemeriksaan Laboratorium</h2>
    <div class="container">
            ...
            <tbody>
                <?php foreach ($hasil_lab as $lab) : ?>
                    <tr>
                        ...
                        <td><?= $lab['hasil']; ?></td>
                        <td>
                            <p <?php if ($lab['keterangan'] != 'Normal') : ?> style="color: red;" <?php endif; ?>><?= $lab['keterangan']; ?></p>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
